...
def demonstrate_code_generation_focus():
    ...
    print("\n✅ OUR MULTI-STAGE VALIDATED GENERATION:")
    ...
    print("  ✓ Fixed 2 indentation issues")
    print("  ✓ Balanced 1 unclosed bracket")

    print("\nStage 3: Security Hardening")
    print("  ⚠️ Found: SQL injection vulnerability")
    print("  ✓ Fixed: Using parameterized queries")
    print("  ⚠️ Found: Plain text password")
    print("  ✓ Fixed: Added bcrypt hashing")

    print("\nStage 4: Test Generation & Validation")
    print("  ✓ Generated 5 unit tests")
    print("  ✓ Generated 3 edge case tests")
    print("  ❌ Test failed: Missing null check")
    print("  ✓ Fixed: Added input validation")

    print("\nStage 5: Final Consensus Review")
    print("  Security Reviewer: ✓ Approved")
    print("  Performance Reviewer: ✓ Optimized query")
    print("  Maintainability Reviewer: ✓ Added docstrings")
